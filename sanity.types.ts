...
// Variable: AUTHOR_BY_NAME_QUERY
// Query: *[_type == "author" && name == $name][0]{    _id,    id,    name,    username,    email,    image,    bio  }
export type AUTHOR_BY_NAME_QUERYResult = {
  _id: string;
  id: number | null;
  name: string | null;
  username: string | null;
